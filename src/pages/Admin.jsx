...
import { BarChart3, ClipboardList, LineChart, MessageSquare, PoundSterling, ShieldAlert, TrendingUp, UserCheck, Users } from 'lucide-react';
      ...
      <div className="rounded-2xl bg-stone-900 p-5 text-white shadow-lift sm:p-6 dark:bg-zinc-900">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex shrink-0 flex-wrap gap-2">
            <Link
              to="/admin/insights"
              className="flex items-center gap-2 rounded-xl border border-stone-600 bg-stone-800 px-4 py-2.5 text-sm font-semibold text-white transition hover:border-stone-400"
            >
              <TrendingUp size={16} />
              Insights
            </Link>
