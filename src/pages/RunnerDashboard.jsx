...
export default function RunnerDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl bg-gradient-to-r from-[#1C1830] to-primary p-5 text-white shadow-lift sm:rounded-[1.5rem] sm:p-6"><p className="text-sm font-black uppercase tracking-wide text-violet-300">Runner dashboard</p><h1 className="mt-2 text-2xl font-black sm:text-3xl">{runner.name}</h1><p className="mt-1 text-white/60">{runner.area} · Active runner</p></div>
