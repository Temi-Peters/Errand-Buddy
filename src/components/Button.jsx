export default function Button({ children, variant = 'primary', className = '', loading = false, as: Component = 'button', ...props }) {
  const variants = {
    primary:   'bg-stone-900 text-white shadow-soft hover:bg-stone-800 dark:bg-stone-100 dark:text-stone-900 dark:hover:bg-white',
    secondary: 'bg-secondary text-white shadow-soft hover:bg-emerald-600',
    outline:   'border border-stone-200 bg-white text-ink shadow-soft hover:bg-stone-50 dark:border-stone-700 dark:bg-surface dark:hover:bg-surface-hi',
