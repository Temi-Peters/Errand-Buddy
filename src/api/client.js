...
export const api = {
  ...
  claimThread: (id) => request(`/claims/${id}/thread`),
  replyToClaim: (id, body) => request(`/claims/${id}/messages`, { method: 'POST', body: { body } }),
  releaseBooking: (id, reason) => request(`/bookings/${id}/release`, { method: 'POST', body: { reason } }),
