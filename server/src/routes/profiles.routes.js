...
import { customers, runners, updateCustomer, updateRunner, updateRunnerProfile, rejectRunner } from '../controllers/profiles.controller.js';
...
runnersRouter.post('/:id/reject', requireAuth, requireRole('ADMIN'), rejectRunner);
